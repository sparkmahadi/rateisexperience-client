    ...
    <div className="max-w-4xl mx-auto p-6 bg-base-100 rounded-lg shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section>
          ...
          <div className="space-y-4">
            {['Quality of Service', 'Professionalism', 'Punctuality', 'Technical Knowledge', 'Communication & Updates', 'Value for Money', 'Overall Satisfaction'].map(
              (item, index) => (
                <div key={index}>
                  ...
                  <input
                    ...
                    value={formData[item.toLowerCase().replace(/ /g, '')]}
                    onChange={handleChange}
                    min="1"
                    max="5"
